...
const CardAdd = (props) => {
    ...
    return (
        <div>
            ...
            {show && <div>
                <textarea value={card} onChange={(e)=>setCard(e.target.value)} className='p-1 w-full rounded-md border-2 bg-white border-zinc-900 text-black placeholder-black' name="" id="" cols="30" rows="2" placeholder='Enter Card Title...'></textarea>
